...
#define STRING_CONFIG_H_AUTHOR "(Leon Heß, AM8 on SKR1.4)" // Who made the changes.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  30.98
    #define DEFAULT_Ki   3.42
    #define DEFAULT_Kd 70.09
  #endif
#else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 396.04, 396.04, 1624.36, 1648.27 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {0, 23, 0 }
